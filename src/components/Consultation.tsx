...
const Consultant: React.FC = () => {
  const [activeChat, setActiveChat] =
    useState<"chatbot" | "dermatology" | "trichology">("chatbot")
  ...
  const generateResponse = (userInput: string, chatType: string): Message => {
    ...
    return {
      id: Date.now().toString(),
      text:
        responses[chatType as keyof typeof responses][
          Math.floor(
            Math.random() *
              responses[chatType as keyof typeof responses].length
          )
        ],
              ...
              {[
                {
                  ...
                  label: "AI Assistant",
                  icon: Bot,
                  desc: "Instant hair care guidance",
                },
                {
                  key: "dermatology",
                  label: "Dermatologist",
                  icon: Stethoscope,
                  desc: "Medical hair & scalp treatment",
                },
                {
                  key: "trichology",
                  label: "Trichologist",
